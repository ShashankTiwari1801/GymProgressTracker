...
public class WeeklyMuscleSet {
    ...
    public boolean isWeekDay(String date){
        ...
        if(Integer.parseInt(T[0]) < Integer.parseInt(M[0])){return false;}
        if(Integer.parseInt(T[1]) < Integer.parseInt(M[1])){return false;}
        if(Integer.parseInt(T[2]) < Integer.parseInt(M[2])){return false;}

        if(Integer.parseInt(T[0]) > Integer.parseInt(S[0])){return false;}
        if(Integer.parseInt(T[1]) > Integer.parseInt(S[1])){return false;}
        if(Integer.parseInt(T[2]) > Integer.parseInt(S[2])){return false;}
